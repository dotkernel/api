...
final class Version20191007120235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `user_detail` (`uuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `userUuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\',`email` varchar(191) DEFAULT NULL, `firstname` varchar(191) DEFAULT NULL, `lastname` varchar(191) DEFAULT NULL, `created` datetime NOT NULL, `updated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4');
        ...
        $this->addSql('ALTER TABLE `user_detail` ADD PRIMARY KEY (`uuid`), ADD UNIQUE KEY `UNIQ_4B5464AED73087E9` (`userUuid`), ADD UNIQUE KEY (`email`)');
