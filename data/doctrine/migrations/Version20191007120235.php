...
final class Version20191007120235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `user` (`uuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `status` varchar(255) NOT NULL, `isDeleted` tinyint(1) NOT NULL, `hash` varchar(255) NOT NULL, `created` datetime NOT NULL, `updated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4');
        $this->addSql('CREATE TABLE `user_avatar` (`uuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `userUuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `name` varchar(255) NOT NULL, `created` datetime NOT NULL, `updated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4');
        $this->addSql('CREATE TABLE `user_detail` (`uuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `userUuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `firstname` varchar(255) NOT NULL, `lastname` varchar(255) NOT NULL, `created` datetime NOT NULL, `updated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4');
        $this->addSql('CREATE TABLE `user_reset_password` (`uuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `userUuid` binary(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', `hash` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL, `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL, `expires` datetime NOT NULL, `created` datetime NOT NULL, `updated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4');
